...
function selection_membres_ajustement_par_demi($requete,$a_regler)
{
	//Remplissage d'un tableau :
	// une ligne (quantité de 0.5 pour 1 membre) : id_membre, nombre aléatoire
	// un meme membre peut être présent plusieurs fois s'il a mis + de 0.5
...
if (isset($_POST['ajustement_haut']))
{
	...
	list($choisis,$nb_choisis)=selection_membres_ajustement_par_demi($requete,$a_regler);
	for ($i=1;$i<=$nb_choisis;$i++)
		{
		echo "<tr>\n";
		echo "<td align='left'>";
